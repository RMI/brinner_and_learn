...
The CI/CD pipeline is our *Continous Publication* mechanism.
It is possible to track `latest` and have up-to-date information, while still
checking against tests, model expecations, invariants, and data quality checks.
...
Web page --> CDN
batch jobn dataset --> Internal blob
:::
...
These affect system design (what is in or out of a system boundry), sometimes
invisibly
