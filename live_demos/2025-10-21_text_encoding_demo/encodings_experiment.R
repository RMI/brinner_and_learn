...
readr::read_csv(csv_file, locale = readr::locale(encoding = "ASCII"))
readr::read_csv(csv_file, locale = readr::locale(encoding = "UTF-8"))

csv_data <- readr::read_csv(csv_file, locale = readr::locale(encoding = "ASCII"))
...
write.csv(df, tmpfile, row.names = FALSE, fileEncoding = "windows-1252")
readr::guess_encoding(tmpfile)
read.csv(tmpfile)
read.csv(tmpfile, fileEncoding = "UTF-8")
readr::read_csv(tmpfile)
...
df <- data.frame(könig = letters[1:2], test = c("2°", "µ"))
...
read.csv(tmpfile)
read.csv(tmpfile, fileEncoding = "UTF-8")
read.csv(tmpfile, fileEncoding = "ISO-8859-2")
read.csv(tmpfile, fileEncoding = "ISO-8859-1")
readr::read_csv(tmpfile)
readr::read_csv(tmpfile, locale = readr::locale(encoding = "UTF-8"))
readr::read_csv(tmpfile, locale = readr::locale(encoding = "windows-1250"))
...
write.csv(df, tmpfile, row.names = FALSE, fileEncoding = "windows-1250")
readr::read_csv(tmpfile, locale = readr::locale(encoding = "UTF-8"))
readr::guess_encoding(tmpfile)
readr::read_csv(tmpfile, locale = readr::locale(encoding = "ISO-8859-2"))
readr::read_csv(tmpfile, locale = readr::locale(encoding = "ISO-8859-1"))
readr::read_csv(tmpfile, locale = readr::locale(encoding = "windows-1250"))
readr::read_csv(tmpfile)
...
write.csv(df, tmpfile, row.names = FALSE, fileEncoding = "UTF-8")
readr::guess_encoding(tmpfile)
readr::read_csv(tmpfile, locale = readr::locale(encoding = "windows-1250"))
readr::read_csv(tmpfile, locale = readr::locale(encoding = "UTF-8"))
